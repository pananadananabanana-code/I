 ...
 */
 bool safety=false; // safetyOff switch.
bool invert = true;
bool KC;
static int  tag = -1;
static int prime = -1;
    ...
    if((target>0)&&(WillPassSpreadInPnL(Ask, target, OP_BUY))){
        if(signature == true){
            if(C==true){
                ...
                if(lOrder_id>0){Print("Buy Executed: Projected PnL exceeds spread friction. Target: ", target);}}}
    } else{
    ...
    if((target>0)&&(WillPassSpreadInPnL(Bid, target, OP_SELL))){
        if(signature==true){
            if(C==true){
                ...
                if(kOrder_id>0){Print("Sell Executed: Projected PnL exceeds spread friction. Target: ", target);}}}
    } else{
        ...
        if(tickTock == false){
            ...
            if((toll == 1) && ((tally == "Buy") || (fg == "Up"))){
                ...
                if(((prime==0)&&(dime==0))&&(fg=="Up")){
                    dime = 0; mem = 0; if(((A == true) || (B == false)) && ((u == true) || (v == false))){ B(); if(C==true){P();} else{Q();} Alert("Bull"); Top(); E = price; } else{ B(); Alert("Bull"); Top(); E = price; }
                    ...
                    dime = 0; mem = 0; if(((A == true) || (B == false)) && ((u == true) || (v == false))){ B(); if(C==true){P();} else{Q();} Alert("Bull"); Top(); E = price; } else{ B(); Alert("Bull"); Top(); E = price; }
                } else if((Price>signal)&&((mem==0)&&(dime==0))){if((safety==true)&&((A == true) || (B == false)) && ((u == true) || (v == false))){ B(); if(C==true){P();} else{Q();} Alert("🥃", "Whisky"); Top(); E = price;} else{Alert("🥃", "Whisky"); Top(); E = price; if(safety!=true){safety=true;}}
                } else/* if((mem==1)||(dime==1))*/{ OnLog(); if((safety==true)&&((A == false) || (B == true)) && ((u == false) || (v == true))){ A(); if(C==false){P();} else{Q();} Alert("🍷", "Wine"); Bott(); D = price;} else{Alert("🍷", "Wine"); Bott(); D = price; if(safety!=true){safety=true;}}}
            ...
            if((toll == 1) && ((tally == "Sell") || (fg == "Down"))){
                ...
                if((fg=="Down")&&((prime==1)&&(dime==1))){
                    dime = 1; mem = 1; if(((A == false) || (B == true)) && ((u == false) || (v == true))){ A(); if(C==false){P();} else{Q();} Alert("Bear"); Bott(); D = price; } else{ A(); Alert("Bear"); Bott(); D = price; }
                    ...
                    dime = 1; mem = 1; if(((A == false) || (B == true)) && ((u == false) || (v == true))){ A(); if(C==false){P();} else{Q();} Alert("Bear"); Bott(); D = price; } else{ A(); Alert("Bear"); Bott(); D = price; }
                } else if((Price<signal)&&((mem==1)&&(dime==1))){if((safety==true)&&((A == false) || (B == true)) && ((u == false) || (v == true))){ A(); if(C==false){P();} else{Q();} Alert("🍷", "Wine"); Bott(); D = price;} else{Alert("🍷", "Wine"); Bott(); D = price; if(safety!=true){safety=true;}}
                } else/* if((mem==0)||(dime==0))*/{ OnLog(); if((safety==true)&&((A == true) || (B == false)) && ((u == true) || (v == false))){ B(); if(C==true){P();} else{Q();} Alert("🥃", "Whisky"); Top(); E = price;} else{Alert("🥃", "Whisky"); Top(); E = price; if(safety!=true){safety=true;}}}
                signal = 0; toll = 0; tally = ""; GF = true; signature = true;
            }
            ...
            if((count == 1) && ((tally == "Buy") || (fg == "Up"))){
                Alert("🔷", "Diamond", fg);
                if(((prime==0)&&(dime==0))&&(fg=="Up")){
                    dime = 0; mem = 0; if(((A == true) || (B == false)) && ((u == true) || (v == false))){ B(); if(C==true){P();} else{Q();} Alert("Hawk"); Top(); E = price; } else{ B(); Alert("Hawk"); Top(); E = price; }
                } else if((((mem==0)&&(dime==0))||(prime==0))&&(fg=="")&&(price>signal)){
                    dime = 0; mem = 0; if(((A == true) || (B == false)) && ((u == true) || (v == false))){ B(); if(C==true){P();} else{Q();} Alert("Hawk"); Top(); E = price; } else{ B(); Alert("Hawk"); Top(); E = price; }}
                else if(((prime==1)||((mem==0)&&(dime==0)))&&(fg=="Up")&&(price>signal)){
                    dime = 0; mem = 0; if(((A == true) || (B == false)) && ((u == true) || (v == false))){ B(); if(C==true){P();} else{Q();} Alert("Hawk"); Top(); E = price; } else{ B(); Alert("Hawk"); Top(); E = price; }
                    ...
                    dime = 0; mem = 0; if(((A == true) || (B == false)) && ((u == true) || (v == false))){ B(); if(C==true){P();} else{Q();} Alert("Hawk"); Top(); E = price; } else{ B(); Alert("Hawk"); Top(); E = price; }
                } else if((Price>signal)&&((mem==0)&&(dime==0))){if((safety==true)&&((A == true) || (B == false)) && ((u == true) || (v == false))){ B(); if(C==true){P();} else{Q();} Alert("💧", "Watter"); Top(); E = price;} else{Alert("💧", "Watter"); Top(); E = price; if(safety!=true){safety=true;}}
                } else/* if((mem==1)||(dime==1))*/{ OnLog(); if((safety==true)&&((A == false) || (B == true)) && ((u == false) || (v == true))){ A(); if(C==false){P();} else{Q();} Alert("🩸", "Blood"); Bott(); D = price;} else{Alert("🩸", "Blood"); Bott(); D = price; if(safety!=true){safety=true;}}}
                count = 0; tally = ""; GF = true; signature = true;
            }
            if((count == 1) && ((tally == "Sell") || (fg == "Down"))){
                Alert("🔻", "Ruby", fg);
                if((fg=="Down")&&((prime==1)&&(dime==1))){
                    dime = 1; mem = 1; if(((A == false) || (B == true)) && ((u == false) || (v == true))){ A(); if(C==false){P();} else{Q();} Alert("Dove"); Bott(); D = price; } else{ A(); Alert("Dove"); Bott(); D = price; }
                } else if((((mem==1)&&(dime==1))||(prime==1))&&(fg=="")&&(price<signal)){
                    dime = 1; mem = 1; if(((A == false) || (B == true)) && ((u == false) || (v == true))){ A(); if(C==false){P();} else{Q();} Alert("Dove"); Bott(); D = price; } else{ A(); Alert("Dove"); Bott(); D = price; }}
                else if((price<signal)&&(fg=="Down")&&((prime==0)||((mem==1)&&(dime==1)))){
                    dime = 1; mem = 1; if(((A == false) || (B == true)) && ((u == false) || (v == true))){ A(); if(C==false){P();} else{Q();} Alert("Dove"); Bott(); D = price; } else{ A(); Alert("Dove"); Bott(); D = price; }
                    ...
                    dime = 1; mem = 1; if(((A == false) || (B == true)) && ((u == false) || (v == true))){ A(); if(C==false){P();} else{Q();} Alert("Dove"); Bott(); D = price; } else{ A(); Alert("Dove"); Bott(); D = price; }
                } else if((Price<signal)&&((mem==1)&&(dime==1))){if((safety==true)&&((A == false) || (B == true)) && ((u == false) || (v == true))){ A(); if(C==false){P();} else{Q();} Alert("🩸", "Blood"); Bott(); D = price;} else{Alert("🩸", "Blood"); Bott(); D = price; if(safety!=true){safety=true;}}
                } else/* if((mem==0)||(dime==0))*/{OnLog(); if((safety==true)&&((A == true) || (B == false)) && ((u == true) || (v == false))){ B(); if(C==true){P();} else{Q();} Alert("💧", "Watter"); Top(); E = price;} else{Alert("💧", "Watter"); Top(); E = price; if(safety!=true){safety=true;}}}
                count = 0; tally = ""; GF = true; signature = true;
            }
        }
